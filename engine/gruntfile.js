...
module.exports = function(grunt) {
    var src = [
        ...
        'src/render/canvas/Graphics.js',
        'src/render/canvas/Texture.js',
        'src/render/canvas/Tinter.js',
        'src/render/canvas/State.js',
        'src/render/canvas/Render.js',
        'src/render/webgl/Consts.js',
        'src/render/webgl/Shader.js',
        'src/render/webgl/shaders/*.js',
        'src/render/webgl/Graphics.js',
        'src/render/webgl/Texture.js',
        'src/render/webgl/Batch.js',
        'src/render/webgl/State.js',
        'src/render/webgl/Render.js',
        'src/input/mouse/Event.js',
        'src/input/mouse/Mouse.js',
        'src/input/keyboard/Event.js',
        'src/input/keyboard/Keyboard.js',
        'src/input/touch/Point.js',
        'src/input/touch/List.js',
        'src/input/touch/Event.js',
